...
layout: docs
title: 什么是 Flomi
description: 使用 Flomi 快速创建工作流，它可以在 Windows 和 MacOS 上运行，用低代码方式来告别重复性工作。
...
<img class="mb-4 img-fluid rounded-3" src="/docs/{{< param docs_version >}}/assets/img/guides/flomi-job-workspace.png" width="2000" height="1000" alt="">
